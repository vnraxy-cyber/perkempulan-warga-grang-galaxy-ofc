function home(){
 ...
 <section class="section"><div class="container"><div class="section-head"><div><div class="kicker">Struktur Organisasi</div><h2>Pengurus Perkumpulan Warga Ruko</h2></div></div>${orgInfographic()}</div></section>
...
function about(){
 ...
 <section class="section compact"><div class="container"><div class="section-head"><div><div class="kicker">Struktur Organisasi</div><h2>Pengurus Perkumpulan Warga Ruko</h2></div></div>${orgInfographic()}</div></section>
...
function sewaJual(){
 return `${hero("Sewa & Jual Ruko","Temukan unit ruko yang disewakan maupun dijual langsung dari pemilik di kawasan Grand Galaxy City.",REAL.ruko,true)}
